    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300">পেমেন্ট ইনিশিয়ালাইজ হচ্ছে...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
          ...
          <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-2">পেমেন্ট ত্রুটি</h2>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
          ...
          {clientSecret && !CheckoutForm && (
            <div className="text-center py-8">
              <div className="text-red-600 dark:text-red-400 mb-4">❌ CheckoutForm component failed to load</div>
              <button
          ...
          {!clientSecret && !loading && !error && (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 dark:text-gray-300">পেমেন্ট লোড হচ্ছে...</p>
            </div>
          )}
        </div>
      </div>
