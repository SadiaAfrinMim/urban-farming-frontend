      ...
      <div className="p-6">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 bg-blue-50 text-blue-700 py-2 px-4 rounded-lg hover:bg-blue-100 transition-colors text-sm font-medium flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="flex-1 bg-red-50 text-red-700 py-2 px-4 rounded-lg hover:bg-red-100 transition-colors text-sm font-medium flex items-center justify-center gap-2"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  if (data.length === 0) {
    return (
      <div className="text-center py-16">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-2">কোন প্রোডাক্ট নেই</h3>
        <p className="text-gray-500 mb-6">আপনার প্রথম প্রোডাক্ট যোগ করুন</p>
