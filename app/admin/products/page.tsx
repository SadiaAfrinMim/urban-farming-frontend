    ...
    return (
      <div className="min-h-screen bg-gray-50 py-12 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-600">{error instanceof Error ? error.message : 'পণ্য লোড করতে সমস্যা হয়েছে'}</p>
          <button
            onClick={() => refetch()}
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <h1 className="text-3xl font-bold text-gray-800 mb-8">পেন্ডিং প্রোডাক্ট রিভিউ</h1>

        {products.length === 0 ? (
          <div className="text-center py-16 bg-white rounded-xl shadow-md">
            <Package className="w-16 h-16 mx-auto text-gray-300 mb-4" />
            <h3 className="text-xl font-semibold text-gray-600 mb-2">কোনো পেন্ডিং প্রোডাক্ট নেই</h3>
            <p className="text-gray-500">সব প্রোডাক্ট রিভিউ এবং অনুমোদিত হয়েছে।</p>
          </div>
        ) : (
